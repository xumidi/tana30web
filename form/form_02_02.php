...
<html lang="ja">
	<head>
		...
		<title>第30回七夕祭 身分証明書データ提出フォーム</title>
	...
	<DIV class="main">
		...
		<H1>第30回七夕祭 身分証明書データ提出フォーム</H1>
		<form action="post.php" method="post" enctype="multipart/form-data" name="consentform" onsubmit="return check()">
		<INPUT style="display: none;" name="formtype[]" value="form0202">
		<div>
			<DIV class="description">
				※団体の代表者の、身分証の画像を実行委員会にお送りください。<BR>
				頂いた身分証の画像は、第30回七夕祭参加規約の第6章第40条個人情報の管理に基づき、責任を持って管理いたします。第30回七夕祭の開催以外の目的には使用せず、終了後はすべてのデータを消去いたします。ご協力お願いいたします。<BR><BR>

				【団体代表者の身分証明書のデータの注意点】<BR>
				この代表者とは、各企画の最終的な責任者であり、トラブルが起きた時に責任を取っていただく方になります。<BR>
				身分証明書は「慶應義塾大学の学生：学生証」「その他の方：免許証もしくは顔写真付き身分証明書」をスキャンし必ずPDFで提出してください。
			</DIV>
