...
<html lang="ja">
	<head>
		...
		<title>第30回七夕祭 食品販売調査書提出フォーム</title>
		<script type="text/javascript">
			...
			function check(){
				if(document.getElementsByName("food_tanto_mail[]")[0].value!="" && document.getElementsByName("groupname[]")[0].value!="" && document.getElementsByName("food_file")[0].value!=""){
	...
	<DIV class="main">
		...
		<H1>第30回七夕祭 食品販売調査書提出フォーム</H1>
		<form action="post.php" method="post" enctype="multipart/form-data" name="consentform" onsubmit="return check()">
		<INPUT style="display: none;" name="formtype[]" value="formfood">
		<div>
			<DIV class="description">
				食品販売を行う団体は、以下をダウンロードのうえ<A HREF="food/examples.zip" target="_blank">記入例 (ZIP形式/約1.3MB)</A>を参考に必要事項を記入してください。<BR>
				<ul>
					<li><A HREF="food/format.zip" target="_blank">食品販売調査書フォーマット・食品販売を行う上での注意 (ZIP形式/約3kB)</A></li>
				</ul>
				<div class="thumbnail">
					<A href="img/food_thumb01.png" target="_blank"><IMG src="img/food_thumb01.png"></A>
					<A href="img/food_thumb02.png" target="_blank"><IMG src="img/food_thumb02.png"></A>
				</DIV>
				「食品販売調査書」「食品販売チェック表」のファイルをZIP形式で圧縮のうえ、ファイル登録で提出してください。
			</DIV>
			<DIV class="bigsection">
				...
				<DIV class="smallsection">
					<SMALLSECTION-TITLE>ファイル登録 (ZIP形式) <small style="color: #ff0000;">[必須]</small></SMALLSECTION-TITLE>
					<INPUT name="food_file" type="file" accept="application/zip">
				</DIV>
			</DIV>
			<DIV class="description">
